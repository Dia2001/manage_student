...
<head>
    ...
    <link href="../CSS/Trangchuv2.css" type="text/css" rel="stylesheet">
    <script>
...
<body onload="myFunction()">
    <div class="header">
        <div class="leftheader">
            <a href="#" class="titlequanly">Quản lý sinh viên</a>
    ...
    <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
        <div class="section">
            <div class="Logindropdown" id="dropdown1">
                ...
                echo "<a href='#'> " . $row['tendangnhap'] . "</a>";
                echo "<a href='#'> " . $row['email'] . "</a>";
                mysqli_close($connect);
                ?>
                <a href="http://localhost/webquanlysinhvien/html/profile-Admin.php"><i class="fas fa-info"></i>Thông tin</a>
    ...
    <div class="Navigation">
        <div class="submenu">
            <a class="listmenu" onclick="openHomePage()"><i class="fas fa-laptop-house"></i>Trang chủ</a>
    ...
    <div style="display:none;" id="myDiv" class="animate-bottom">
        <div class="mainform">
            <div class="contentQuery" id="contentPageCurrent"> <object type="text/html" data="http://localhost/webquanlysinhvien/HTML/PageHome.php" width=100% height=100%></object></div>
        </div>
    </div>
    </div>
    <script>
        ...
        function openHomePage() {
            document.getElementById("contentPageCurrent").innerHTML = '<object type="text/html" data="http://localhost/webquanlysinhvien/HTML/PageHome.php" width=100% height=100%></object>';
        }
        function opengiangvien(){
            document.getElementById("contentPageCurrent").innerHTML='<object type="text/html" data="http://localhost/webquanlysinhvien/html/giangvien.php" width=100% height=100%></object>';
        }
        function opendiem() {
            document.getElementById("contentPageCurrent").innerHTML = '<object type="text/html" data="http://localhost/webquanlysinhvien/HTML/diem.php" width=100% height=100%></object>';
        }
        function openKhoa() {
            document.getElementById("contentPageCurrent").innerHTML = '<object type="text/html" data="http://localhost/webquanlysinhvien/HTML/khoa.php" width=100% height=100%></object>';
        }

        function openlop() { //sự kiện load trang lớp
            document.getElementById("contentPageCurrent").innerHTML = '<object type="text/html" data="http://localhost/webquanlysinhvien/html/lop.php" width=100% height=100%></object>';
        }
        function openchucvu() { //load trang sinh vien
            // Tui để tạm bảng CHỨC VỤ
            document.getElementById("contentPageCurrent").innerHTML = '<object type="text/html" data="http://localhost/webquanlysinhvien/html/chucvu.php" width=100% height=100%></object>';
        }
        function openchuongtrinh() { //load trang môn học
            // Tui để tạm bảng CHƯƠNG TRÌNH		
            document.getElementById("contentPageCurrent").innerHTML = '<object type="text/html" data="http://localhost/webquanlysinhvien/html/chuongtrinh.php" width=100% height=100%></object>';
        }

        function openkhoahoc() { //load trang điểm số
            // Tui để tạm bảng KHÓA HỌC	
            document.getElementById("contentPageCurrent").innerHTML = '<object type="text/html" data="http://localhost/webquanlysinhvien/html/khoahoc.php" width=100% height=100%></object>';
        }

        function openquequan() { //load
            // Tui để tạm bảng Quê Quán				
            document.getElementById("contentPageCurrent").innerHTML = '<object type="text/html" data="http://localhost/webquanlysinhvien/html/quequan.php" width=100% height=100%></object>';
        }

        function opensv() { //load

            document.getElementById("contentPageCurrent").innerHTML = '<object type="text/html" data="http://localhost/webquanlysinhvien/html/sinhvien.php" width=100% height=100%></object>';
        }

        function opentinhtrang() { //load

            document.getElementById("contentPageCurrent").innerHTML = '<object type="text/html" data="http://localhost/webquanlysinhvien/html/tinhtranghoc.php" width=100% height=100%></object>';
        }

        function opennganhhoc() { //load

            document.getElementById("contentPageCurrent").innerHTML = '<object type="text/html" data="http://localhost/webquanlysinhvien/html/monhocnganh.php" width=100% height=100%></object>';
        }

        function opennganh() { //load

            document.getElementById("contentPageCurrent").innerHTML = '<object type="text/html" data="http://localhost/webquanlysinhvien/html/nganh.php" width=100% height=100%></object>';
        }

        function opengiangkhoa() { //load

            document.getElementById("contentPageCurrent").innerHTML = '<object type="text/html" data="http://localhost/webquanlysinhvien/html/giangkhoa.php" width=100% height=100%></object>';
        }
