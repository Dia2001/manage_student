...
<html>
    <head>
        ...
        <link href="../CSS/Areagiangvien.quanlysinhviencss.css" type="text/css" rel="stylesheet">
        <script>
    ...
    <body onload="myFunction()">
        <div class="header">
            ...
            <a href="#" class="titlequanly"><i class="fas fa-chalkboard-teacher"></i>Quản lý sinh viên</a>
            ...
            <?php
        $magv = $_SESSION['usr'];
        $sql = "select * from giangvien where magiangvien='" . $magv. "'";
        ...
        <div class="section">
            <div class="Logindropdown" id="dropdown1">
                ...
                echo "<a href='#'> " . $row['hotengv'] . "</a>";
                mysqli_close($connect);
                ?>
                <a href="http://localhost/webquanlysinhvien/html/profile-Giangvien.php"><i class="fas fa-info"></i>Thông tin</a>
    ...
    ?>
            ...
            <div style="display:none;" id="myDiv" class="animate-bottom">
                <div class="mainform">
                    <div class="contentQuery" id="contentPageCurrent"> <object  data="http://localhost/webquanlysinhvien/HTML/Areagiangvien.sinhvien.php" width=100% height=100%></object></div>
                </div>
            </div>
        </div>
        <script>
           ...
           function opendiem(){//sự kiện load trang khoa
            document.getElementById("contentPageCurrent").innerHTML='<object type="text/html" data="http://localhost/webquanlysinhvien/html/Areagiangvien.diem.php" width=100% height=100%></object>';
       }
            function openKhoa(){//sự kiện load trang khoa
                 document.getElementById("contentPageCurrent").innerHTML='<object type="text/html" data="http://localhost/webquanlysinhvien/HTML/Areagiangvien.khoa.php" width=100% height=100%></object>';
            }
            function openlop(){//sự kiện load trang lớp
                 document.getElementById("contentPageCurrent").innerHTML='<object type="text/html" data="http://localhost/webquanlysinhvien/HTML/Areagiangvien.lop.php" width=100% height=100%></object>';
            }
            
            function opensv(){//load
							
                 document.getElementById("contentPageCurrent").innerHTML='<object type="text/html" data="http://localhost/webquanlysinhvien/HTML/Areagiangvien.sinhvien.php" width=100% height=100%></object>';
            }
           
            function opennganhhoc(){//load
							
                document.getElementById("contentPageCurrent").innerHTML='<object type="text/html" data="http://localhost/webquanlysinhvien/HTML/Areagiangvien.monhocnganh.php" width=100% height=100%></object>';
           }
           function opennganh(){//load
							
            document.getElementById("contentPageCurrent").innerHTML='<object type="text/html" data="http://localhost/webquanlysinhvien/HTML/Areagiangvien.nganh.php" width=100% height=100%></object>';
            }
