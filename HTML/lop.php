        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="wrapper">
                    ...
                    <div>
                        <button class='btn btn-success' onclick="window.open('inputClass.php','_self')"><i class="bi bi-plus-lg"></i>Thêm mới</button>
                    </div>
                </div>
                <?php
                $dong = 6;
                ...
                foreach ($classlist as $cla) {
                    echo '<tr>
                        ...
                        <td><button class="btn btn-warning" onclick=\'window.open("inputClass.php?id=' . $cla['malop'] . '","_self")\'><i class="bi bi-brush"></i>Sửa</button></td>
                        <td><button class="btn btn-danger" onclick="deleteqs(\'' . $cla['malop'] . '\')"><i class="bi bi-trash"></i>Xóa</button></a></td>
                    </tr>';
                }
                echo "</tbody>";
                echo "<table>";
                ...
                for ($i = 0; $i <= $sotrangdl; $i++) {
                    $trangchon = $i + 1;
                    echo "<li class='list-group-item page-item'><a href='lop.php?page=$i'>$trangchon</a></li>";
                }
                echo "</ul>";
                ?>
                <script type="text/javascript">
                    function deleteqs(malop) {
                        console.log(malop)
